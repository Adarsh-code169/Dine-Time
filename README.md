...
- **Discover Restaurants**: Browse through restaurants using customized and interactive `RestaurantCard` components.
- **Menu Exploration**: View detailed dishes and specials via `MenuItem` components.
- **Cart & Order Management**: Easily manage food orders inside the Cart and check past orders in the History tab.
...
- **Toolset/Routing**: [Expo](https://expo.dev/) & [Expo Router](https://docs.expo.dev/router/introduction/)
